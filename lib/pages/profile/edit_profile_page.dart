...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future<void> pickAvatar() async {
    ...
    prefs.saveAvatar(result.files.single.path!);
  }
          ...
          Positioned(
            child: isLoading
                ?  Container(
                        ...
                        child: const CircularProgressIndicator(color: AppColor.greyText,)
                      )
                : fileAvatar != null
                    ? Container(
                        height: 120.5,
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: FileImage(File(fileAvatar!)),
                              )),
                        ),
                      )
                    : widget.user.avatar != null
                        ? _avatarProfile(widget.user.avatar ?? "")
                        : CircleAvatar(
                            radius: 12.0,
                            child: Image.asset(
